...
class StarWarsCharactersData():
    ...
    def get_top_10_characters(self, characters):
        """
        ...
        return sorted(characters, key=lambda x: x["appearances"], reverse=True)[:10]


    def sort_characters_by_height(self, characters):
        """
        ...
        return sorted(characters, key=lambda x: x["height"] or 0, reverse=True)


    def write_csv_file(self, filename, fieldnames, data):
        """
    ...
    def send_csv_file_to_server(self, filename, server_url):
        """
